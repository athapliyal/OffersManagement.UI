...
1. Import all necessary dependencies - similar to using statements on top on C# files
...
8. If you understand this InfiniteScroll component you just learnt 75% of React. Rest 25% are advanced concepts
*/
...
export const InfiniteScroll: React.FC = () => {
  ...
  // Here we are firing a reques to the backend to add 20000 offers so we have enough data to show Infinite Scroll
